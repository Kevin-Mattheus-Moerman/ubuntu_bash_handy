...
synclient FingerLow=4 # 4
synclient FingerHigh=5 #5
synclient MaxTapTime=0 #0
synclient MaxTapMove=162 #162
synclient MaxDoubleTapTime=180
synclient SingleTapTimeout=180
synclient ClickTime=100 #100
...
synclient MaxSpeed=10 #1.75
synclient AccelFactor=0.1 #0.0542299
...
synclient CoastingSpeed=20 #20
synclient CoastingFriction=40 #50
